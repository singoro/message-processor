...
namespace Databases
{
    public class DatabaseMethods
    {
        ...
        public Boolean IsAttributesEmailForGivenEmailOnGiveDateSent(int emailID, string date)
        {
            ...
            MySqlConnection conn = new(_mySqöConnectionString);
            conn.Open();
        ...
        {
            Boolean returnResult = false;
            MySqlConnection mConnection = new(_mySqöConnectionString);
            StringBuilder sCommand = new("INSERT INTO messaging.attributes (attEmailId, attribute,date) VALUES ");
        ...
        public Boolean SaveEmailSentToDatabase(int emailId, string emailBody)
        {
            Boolean returnResult = false;
            MySqlConnection mConnection = new(_mySqöConnectionString);
            StringBuilder sCommand = new("INSERT INTO messaging.sendemails (emailId, emailtext,date) VALUES ");
            try
            {
                MySqlCommand comm = mConnection.CreateCommand();
